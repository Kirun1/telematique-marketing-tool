...
require_once PRODUCT_SCRAPER_PLUGIN_PATH . 'includes/analytics/class-content-analytics.php';
require_once PRODUCT_SCRAPER_PLUGIN_PATH . 'includes/analytics/class-competitor-analysis.php';
