            ...
            <div class="sa-sidebar">
                ...
                <div class="sa-nav-section">
                    ...
                    <ul class="sa-nav">
                        ...
                        <li class="active"><a href="<?php echo admin_url('admin.php?page=seo-analysis'); ?>"><span class="dashicons dashicons-chart-line"></span> &nbsp; SEO Analysis</a></li>
                        <li><a href="<?php echo admin_url('admin.php?page=link-manager'); ?>"><span class="dashicons dashicons-admin-links"></span> &nbsp; Link Manager</a></li>
                    </ul>
                </div>
                ...
                <div class="sa-feature-notice">
                    ...
                    <p class="feature-desc">Complete SEO audit with actionable insights.</p>
                </div>
            ...
            <div class="sa-main-content">
                ...
                <div class="sa-section">
                    ...
                    <div class="sa-analysis-section">
                        <h3><span class="dashicons dashicons-admin-tools"></span> Technical SEO Analysis</h3>
                    ...
                    <div class="sa-analysis-section">
                        <h3><span class="dashicons dashicons-edit"></span> Content SEO Analysis</h3>
                    ...
                    <div class="sa-analysis-section">
                        <h3><span class="dashicons dashicons-performance"></span> Performance Analysis</h3>
                    ...
                    <!-- Action Plan -->
                    <div class="sa-analysis-section">
                        <h3><span class="dashicons dashicons-clipboard"></span> SEO Action Plan</h3>
