                ...
                <div class="sa-container">
                    <div class="sa-sidebar">
                        <div class="sa-nav-section">
                            <h3>ANALYSIS</h3>
                            <ul class="sa-nav">
                                <li><a href="/wp-admin/admin.php?page=scraper-analytics"><span class="dashicons dashicons-dashboard"></span> &nbsp; Dashboard</a></li>
                                <li><a href="/wp-admin/admin.php?page=scraper-keywords"><span class="dashicons dashicons-tag"></span> &nbsp; Keywords</a></li>
                                <li><a href="/wp-admin/admin.php?page=scraper-competitors"><span class="dashicons dashicons-chart-bar"></span> &nbsp; Competitors</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="sa-nav-section">
                            <h3>DATA</h3>
                            <ul class="sa-nav">
                                <li class="active"><a href="/wp-admin/admin.php?page=product-scraper"><span class="dashicons dashicons-download"></span> &nbsp; Product Scraper</a></li>
                                <li><a href="/wp-admin/admin.php?page=scraper-reports"><span class="dashicons dashicons-media-text"></span> &nbsp; Reports</a></li>
                                <li><a href="/wp-admin/admin.php?page=scraper-settings"><span class="dashicons dashicons-admin-generic"></span> &nbsp; Settings</a></li>
                            </ul>
                        </div>
