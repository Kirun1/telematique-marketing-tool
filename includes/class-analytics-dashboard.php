    ...
    private function get_seo_reports()
    {
        ...
        return array(
            ...
            'technical_health' => array(
                array('label' => 'Page Speed', 'score' => 82, 'status' => 'good'),
                array('label' => 'Mobile Friendly', 'score' => 95, 'status' => 'excellent'),
                array('label' => 'SSL Security', 'score' => 100, 'status' => 'excellent'),
                array('label' => 'Structured Data', 'score' => 65, 'status' => 'average'),
                array('label' => 'Internal Linking', 'score' => 58, 'status' => 'needs-improvement')
            ),
            'top_content' => array(
                array(
