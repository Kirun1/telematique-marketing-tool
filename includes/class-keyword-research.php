...
class ProductScraper_Keyword_Research
{
    ...
    private function suggest_content_type($keyword)
    {
        ...
        if (strpos($keyword_lower, 'how to') !== false) return 'guide';
        if (strpos($keyword_lower, 'vs') !== false) return 'comparison';
        if (strpos($keyword_lower, 'review') !== false) return 'review';
        if (strpos($keyword_lower, 'buy') !== false) return 'product_page';
    ...
    {
        return array(
            array('keyword' => 'main product', 'position' => 1),
            array('keyword' => 'related service', 'position' => 3),
            array('keyword' => 'industry term', 'position' => 5)
        );
    }
    ...
    {
        return array(
            array('page' => '/products/main-product', 'traffic_share' => 35),
            array('page' => '/blog/guide', 'traffic_share' => 20),
            array('page' => '/about', 'traffic_share' => 15)
        );
    }
